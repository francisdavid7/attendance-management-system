...
const heroSection = () => {
  return (
    <main className="">
      <div className="">
        <section className="p-4 mx-auto max-w-[85%]  flex items-center gap-10 flex-wrap ">
          <div className="mx-auto grow w-full md:w-96">
            <Badge
              variant="outline"
              className="py-3 px-4 bg-muted/20 text-primary"
            >
              <BadgeCheck />
            ...
            <p className="text-[14px] mt-4 leading-6 text-secondary">
              Streamline campus operations with automated QR check- ins,
              real-time analytics, and seamless tutor verification. Designed for
              precision.
            </p>
        ...
        <section className="bg-[color:var(--color-card)] w-full md:w-full  text-center ">
          ...
          <p>
            Precision engineering for educational institutions who demand more
            from their <br /> digital ecosystems.
          </p>
          ...
          <div className="group relative w-full max-w-3xl overflow-hidden rounded-[32px] bg-[color:var(--color-primary)] p-10 text-white shadow-[0_26px_70px_-30px_rgba(15,23,42,0.45)] transition duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_32px_80px_-30px_rgba(15,23,42,0.5)]">
            <div className="flex flex-col gap-5">
              <h1 className="text-4xl font-extrabold tracking-tight">
                Scale Your Campus Oversight
              </h1>

              <p className="max-w-2xl text-[20px] leading-8 opacity-90 mx-auto">
                Join the future of institutional management. Setup takes
                minutes; results last a lifetime.
              </p>

              <div className="flex flex-wrap justify-center gap-4 pt-1">
                <button className="rounded-[10px] bg-white px-9 py-4 text-sm font-bold text-black transition hover:scale-[1.02] hover:shadow-xl">
                  Start Free Trial
                </button>
                <button className="rounded-[10px] border border-white/30 bg-white/10 px-9 py-4 text-sm font-bold text-white transition hover:bg-white/20 hover:shadow-lg">
                  Schedule Demo
                </button>
              </div>

              <p className="mt-6 text-[15px] font-semibold opacity-80">

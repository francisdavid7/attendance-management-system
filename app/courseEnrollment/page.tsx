...
import { getCurrentUser, getAllCourses, enrollCourse, checkCourse } from "@/lib/actions/actions";
...
export default function CourseEnrollment() {
    ...
    return (
        <div className="w-[40%] mt-auto mb-auto ml-auto mr-auto">
            <Card>
                <CardHeader>
                            ...
                            <div className="">
                                <div>
                                    <div className="flex gap-1 text-sm text-muted-foreground">
                                        Student Name <GraduationCapIcon className="text-(--color-primary)" />
                                    </div>
